...
```
PUT http://localhost:8080/api/me/profile
Content-Type: application/json
Authorization: Bearer <token>
```
```json
...
```
PUT http://localhost:8080/api/me/recruiter
Content-Type: application/json
Authorization: Bearer <token>
```
```json
...
### GET users
```
GET http://localhost:8080/api/users?id=USER_UUID
Authorization: Bearer <token>
```
...
```
POST http://localhost:8080/api/files/resume
Authorization: Bearer <token>
...
```
POST http://localhost:8080/api/files/logo
Authorization: Bearer <token>
Content-Type: multipart/form-data
```
...
### GET files/url
```
GET http://localhost:8080/api/files/url?key=OBJECT_KEY
Authorization: Bearer <token>
```
...
```
PATCH http://localhost:8080/api/invitations?id=INVITATION_UUID
Content-Type: application/json
Authorization: Bearer <token>
```
```json
...
```
PATCH http://localhost:8080/api/applications?id=APPLICATION_UUID
Content-Type: application/json
Authorization: Bearer <token>
```
```json
...
```
GET http://localhost:8080/api/search/users?role=student&email=aleksey
Authorization: Bearer <token>
```
